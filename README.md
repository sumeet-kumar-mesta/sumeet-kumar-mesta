...
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=28&duration=2000&pause=1000&center=true&vCenter=true&width=600&height=40&lines=Hi%2C+I'm+Sumeet+Kumar!;Technical+Lead;8%2B+Years+Experience;Let's+Build+Something+Amazing+%F0%9F%9A%80" alt="Typing SVG" /></a>
  <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="30">
</h1>
...
const sumeet = {
    ...
    currentStatus: "Lazy software engineer",
...
- **Frontend**: React, Vue.js, NextJs with responsive design
...
### 🏆 **Mesta (Senior Software Engineer)** - *May 2026 to present & to the Moon*
- 🎮 **Enabling global cross border payments via stablecoing and fiat currency** - Built Nodejs NestJs systems handling millions of daily requests

### 🏆 **Deel (Senior Software Engineer)** - *July 2025 to March 2026*
- 🎮 **Worked on global payroll management at scale** - Built Nodejs NestJs systems handling millions of daily requests
...
```mermaid
graph TD
    A[What I can do?] --> B[Technical Leadership]
    A --> C[CTO Consulting] 
